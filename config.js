{"comics":[["Screen orientation","first-image.svg","May 11, 2019","My first post! I will be posting weekly until I get good at it, then I will try for daily.","Isaac attempts to fix the screen orientation on his computer"],
        ...
        ["If I Were A Superhero...","if_i_were_a_superhero.svg","November 21, 2020","*Recalls the days of the Upshutting*","Seymour makes a wish for <div style = \"background-color:black;color:black;width:100px;height:16px;overflow-x:hidden;\">I can't believe you actually went to the trouble of finding this text...</div>"]
    ]
}
